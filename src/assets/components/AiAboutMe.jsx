  ...
  return (
    <div className='container mx-auto grid grid-cols-2 mt-[20vh] mb-[20vh]'>
        <div className='lg:col-span-1 col-span-2 text-white text-3xl text-center grid grid-flow-row auto-rows-max'>
            ...
            className="text-5xl font-medium font-ClashDisplay mb-6 relative z-10">
                Little About Me 
            </div>
            <div className='lg:text-xl md:text-lg text-sm items-center flex flex-col font-light font-LandRover mt-2 relative'>
                <p 
                onMouseEnter={setHover}
                onMouseLeave={setDefault}
                className="relative">
